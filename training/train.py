...
def get_args():
    ...
    parser.add_argument("--load_dataset_from_disk", type=str, default=False)
    ...
    parser.add_argument("--run_name", type=str, default="default-run-name")
...
def create_datasets(tokenizer, args):
    if not args.load_dataset_from_disk:
